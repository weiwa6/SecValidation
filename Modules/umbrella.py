...
def dnslookup():
    ...
    result = {}
    if 'server' in data and 'name' in data:
        result = dns_lookup(data["name"], data["server"])

    return Response(json.dumps(result), status=200, mimetype='application/json')


if __name__ == '__main__':
    print(dns_lookup('ihaveabadreputation.com', "208.67.222.222"))
    print(dns_lookup('internetbadguys.com', "208.67.222.222"))
